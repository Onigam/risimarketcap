...
/* harmony import */ var _data_currencies__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../data/currencies */ "./data/currencies.js");
...
var renderCurrencyRow = function renderCurrencyRow(currency) {
  return __jsx("tr", {
    ...
    __self: this
  }, currency.price_usd.toFixed(3)), __jsx("td", {
    __source: {
      fileName: _jsxFileName,
      lineNumber: 15
    },
    __self: this
  }, currency.volume_usd.toFixed(3)), __jsx("td", {
    __source: {
      fileName: _jsxFileName,
      lineNumber: 16
    },
    ...
    __self: this
  }, currency.price_change.toFixed(3)));
};

var Page = function Page() {
  var currencies = _data_currencies__WEBPACK_IMPORTED_MODULE_3__["default"].data;
  return __jsx("table", {
    className: "table",
    __source: {
      fileName: _jsxFileName,
...
//# sourceMappingURL=index.js.6295489be7ad6a00eb9a.hot-update.js.map